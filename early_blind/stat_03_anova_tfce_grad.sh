...
#SBATCH -p long
#SBATCH -o /gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/scps/log/gd_tfce.out 
#SBATCH -e /gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/scps/log/gd_tfce.err
#SBATCH -c 1
#SBATCH -a 1-50
...
s1=/gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/stats/perm_tfce/grad/g1
s2=/gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/stats/perm_tfce/grad/g2
s3=/gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/stats/perm_tfce/grad/g3
...
# python /gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/scps/stat_03_anova_tfce.py $da $sa 100 angle ${SLURM_ARRAY_TASK_ID} 
# python /gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/scps/stat_03_anova_tfce.py $db $sb 100 magni ${SLURM_ARRAY_TASK_ID} 
# python /gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/scps/stat_03_anova_tfce.py $dc $sd 100 angle ${SLURM_ARRAY_TASK_ID} 
# python /gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/scps/stat_03_anova_tfce.py $dd $sd 100 magni ${SLURM_ARRAY_TASK_ID} 
python /gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/scps/stat_03_anova_tfce.py $d1 $s1 100 g1z ${SLURM_ARRAY_TASK_ID}
python /gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/scps/stat_03_anova_tfce.py $d2 $s2 100 g2z ${SLURM_ARRAY_TASK_ID} 
python /gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/scps/stat_03_anova_tfce.py $d3 $s3 100 g3z ${SLURM_ARRAY_TASK_ID} 
# python /gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/scps/stat_03_anova_tfce.py $d1 $s1 100 fc1z ${SLURM_ARRAY_TASK_ID} 
# python /gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/scps/stat_03_anova_tfce.py $d2 $s2 100 fc2z ${SLURM_ARRAY_TASK_ID} 
# python /gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/scps/stat_03_anova_tfce.py $d3 $s3 100 fc3z ${SLURM_ARRAY_TASK_ID} 
# python /gpfs3/well/margulies/users/anw410/data/blindness/serious_3rd/scps/stat_03_anova_tfce.py $d4 $s4 100 fc4z ${SLURM_ARRAY_TASK_ID} 